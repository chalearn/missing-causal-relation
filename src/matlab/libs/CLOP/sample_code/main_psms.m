% % %  Out of date, you may want to use the updated script: using_psms.m,
% % %  in this folder. 
% % % 
% % % 
...
% % % Create the object
psms_model    = psmsx(neural,{'redfactor=5','maxiter=1','fms=1'});
[dat,psms_output]=train(psms_model,D.train);% % my_model now contains the best model found by psms 
my_model=psms_output.Best_model;
