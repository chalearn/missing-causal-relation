function a = saliency_fs(hyper) 

%=========================================================================
% Saliency feature ranking
%=========================================================================   
% A=saliency_fs(H) returns a fold object initialized with hyperparameters H. 
% 
...
%
%  Example:
%  d=gen(toy); a=saliency_fs('w_min=0.2'); a.f_max=20; [r,a]=train(a,d);
...
algoType=algorithm('saliency_fs');
a= class(a,'saliency_fs',algoType);
