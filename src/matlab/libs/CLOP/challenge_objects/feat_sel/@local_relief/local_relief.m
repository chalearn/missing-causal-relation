function a = local_relief(hyper) 

%=========================================================================
% Local Relief feature ranking
%=========================================================================   
% A=LOCAL_RELIEF(H) returns a pearson object initialized with hyperparameters H. 
%
...
algoType=algorithm('local_relief');
a= class(a,'local_relief',algoType);
