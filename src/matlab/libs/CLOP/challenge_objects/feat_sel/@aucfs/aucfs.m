function a = aucfs(hyper) 

%=========================================================================
% Feature ranking according to the AUC criterion
%=========================================================================   
% A=AUC(H) returns a auc object initialized with hyperparameters H. 
%
% The train method ranks features with the AUC statistic.
...
%
%  Example:
%  d=gen(toy); a=aucfs('w_min=0.2'); a.f_max=20; [r,a]=train(a,d);
...
algoType=algorithm('aucfs');
a= class(a,'aucfs',algoType);
