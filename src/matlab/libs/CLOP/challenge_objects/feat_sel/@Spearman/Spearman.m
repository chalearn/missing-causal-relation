function a = Spearman(hyper) 

%=========================================================================
% Feature ranking according to the Spearman correlation coefficient
%=========================================================================   
% A=Spearman(H) returns a Spearman object initialized with hyperparameters H. 
%
% The train method ranks features with the Spearman correlation coefficient.
...
%
%  Example:
%  d=gen(toy); a=Spearman('w_min=0.2'); a.f_max=20; [r,a]=train(a,d);
%  get_fidx(a)  % lists the chosen features in  order of importance, using 20 features
%
% Isabelle Guyon -- isabelle@clopinet.com -- Oct 2013
...
a.fidx=[];
a.w=[]; % signed weights
a.W=[]; % unsigned weights
a.pval=[];
a.fdr=[];

algoType=algorithm('Spearman');
a= class(a,'Spearman',algoType);
