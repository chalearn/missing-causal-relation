function a = psmsx_gui(algox,hyper) 
%=====================================================================================
%  Graphical user interface for the Particle swarm model selection object      
%=====================================================================================   
...
a.w_start   =    default(1.2, [0 5]);      %  starting inertia weigth
...
p=algorithm('psmsx_gui');
a= class(a,'psmsx_gui',p);
