function [Idxs, WS, K, D2] = relief_large2(X, Y, feat_num, K, group_feat, nosort, D2)
% [Idxs, WS, K, D2] = relief_large2(X, Y, feat_num, K, group_feat, nosort, D)
% Like Relief bu uses the K nearest hits and a new normalization.
% Inputs:
