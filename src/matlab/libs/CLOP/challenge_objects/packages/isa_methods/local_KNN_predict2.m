function [Y_resu, Y_conf, name] = local_KNN_predict2(X_test, param, idx_feat, X_train, Y_train)
%[Y_resu, Y_conf, name] = local_KNN_predict2(X_test, param, idx_feat, X_train, Y_train)
...
[Y_score, K] = local_knnclass2(X_train, Y_train, X_test, Y_test, K, [],[], idx_feat);
Y_score=Y_score+B;    
