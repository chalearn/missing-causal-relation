function [h, spefound, senfound, espefound, esenfound] = roc(Output, Target, senval, speval, sim_name, silent, h, col, inv_axis)
%function [h, spefound, senfound, espefound, esenfound] = roc(Output, Target, senval, speval, sim_name, silent, h, col, inv_axis)
...
if ~silent
    ...
    hold on
    if inv_axis
        plot(1 - Sspecificity, Ssensitivity, col, 'LineWidth',lw);
        plot([0 1], [0 1], 'k');
    else
