...
% GETPROPERTY - get named kernel property
%
%    VALUE = GETPROPERTY(KERNEL,'PROPERTY') returns the value of the named
%    property of a kernel object. 

%
% File        : @kernel/getproperty.m
%
% Date        : Monday 27th August 2007
%
% Author      : Dr Gavin C. Cawley
%
% Description : Retrieve the value of a named property of a kernel object.
%
