...
%
% GET - retrieve named properties of an object
%
%    [VALUE, ...] = GET(OBJECT, 'PROPERTY', ...) returns the values of the
...
%
% Description : Retrieve values of the named properties of an object.
%
